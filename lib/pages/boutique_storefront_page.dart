        ...
        child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, boutiqueSnapshot) {
            ...
            if (boutiqueSnapshot.hasError) {
              return const Center(
                child: Text('Failed to load boutique',
            ...
            final boutiqueDescription = boutiqueData['description']?.toString() ?? 'No description available.';
                    ...
                    children: [
                      ...
                      bannerPath.isNotEmpty
                        ...
                        errorBuilder: (context, error, stackTrace) =>
                            Container(height: 220, color: fieldColor),
                      )
                          : Container(
                        height: 220,
                        width: double.infinity,
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: BoutiqueLogoAvatar(imageUrl: logoPath, size: 80),
                        ),
                      ),
                    ],
                  ),
                    ...
                    builder: (context, productsSnapshot) {
                      if (productsSnapshot.connectionState == ConnectionState.waiting) {
                        return const Padding(
                          ...
                          child: Center(child: CircularProgressIndicator(color: deepAccent)),
                        );
                      }
                          ...
                          Padding(
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final title = data['title']?.toString() ?? 'Untitled Product';
